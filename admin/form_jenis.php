...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			<form action="aksi_form_jenis.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Input Jenis Buku</h2> 

				<div class="row form-group">
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">Kode Jenis</label>
						<input type="text" name="kode_jenisbuku" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-8">
						<label class="text-black" for="email">Nama Jenis</label> 
						<input type="text" name="nama_jenisbuku" class="form-control rounded-0">
					</div>
				</div>
