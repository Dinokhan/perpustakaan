<?php 
include "../koneksi.php";
$tampil=mysqli_query($koneksi, "SELECT * FROM jenis_buku where kode_jenisbuku='$_GET[id]'");
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			...
			<div class="alert alert-success" role="alert">
				<h4 align="center">Jenis Buku</h4>

			</div>
		</div>
		<div class="container alert alert-dark">
			<form action="aksi_update_jenisbuku.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Ubah Jenis Buku</h2> 

				<div class="row form-group">
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">Kode Jenis Buku</label>
						<input type="text" name="kode_jenisbuku" readonly value="<?php echo $r['kode_jenisbuku'];?>" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-8">
						<label class="text-black" for="email">Nama Jenis Buku</label> 
						<input type="text" name="nama_jenisbuku" value="<?php echo $r['nama_jenisbuku'];?>" class="form-control rounded-0">
					</div>
				</div>
