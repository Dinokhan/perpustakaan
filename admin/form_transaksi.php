	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			...
			<div class="alert alert-success" role="alert">
				<h4 align="center">Transaksi Peminjaman</h4>

			</div>
		</div>
		<div class="container alert alert-dark">
			<form action="aksi_form_transaksi.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Input Data</h2> 

				<div class="row form-group">
				

				<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="lname">Id Peminjaman</label> 
						<select name="id_peminjaman" class="form-control">
    <option value="" selected="selected">-</option>
    <?php 
     $tampil=mysqli_query($koneksi,"SELECT * FROM peminjaman ORDER BY id_peminjaman");
     while($r=mysqli_fetch_array($tampil)){
      echo "<option value=$r[id_peminjaman]>$r[id_peminjaman]</option>";
     }
     ?>
 </select>
					</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">Tardiness</label>
						<input type="text" name="tardiness" class="form-control rounded-0"
						placeholder=" Hari">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="subject">Denda</label> 
						<input type="subject" name="denda" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="subject">QTY</label> 
						<input type="subject" name="qty" class="form-control rounded-0">
					</div>
				</div>
