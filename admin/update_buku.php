<?php 
include "../koneksi.php";
$tampil=mysqli_query($koneksi, "SELECT * FROM buku where kd_buku='$_GET[id]'");
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			<form action="aksi_update_buku.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Ubah Buku</h2> 

				<div class="row form-group">
					<div class="col-lg-4">
						<label class="text-black" for="fname">Kode Buku</label>
						<input type="text" name="kd_buku" readonly value="<?php echo $r['kd_buku'];?>" class="form-control">
					</div>
					<div class="col-lg-4">
						<label class="text-black">Judul Buku</label>
						<input type="text" name="judul_buku" value="<?php echo $r['judul_buku'];?>" class="form-control">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-12">
						<label class="text-black" for="fname">Pengarang</label> 
						<input type="text" name="pengarang" value="<?php echo $r['pengarang'];?>" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-12">
						<label class="text-black" for="subject">Kode J.Buku</label> 
						<input type="subject" name="kode_jenisbuku"  value="<?php echo $r['kode_jenisbuku'];?>" class="form-control rounded-0">
					</div>
				</div>

				<div class="row form-group">
					<div class="col-md-8 mb-3 mb-md-0">
						<label class="text-black" for="fname">Penerbit</label>
						<input type="text" name="penerbit" value="<?php echo $r['penerbit'];?>" class="form-control rounded-0">
					</div>
					<div class="col-md-2">
						<label class="text-black" for="lname">Tahun Terbit</label>
						<input type="text" name="tahun_terbit" value="<?php echo $r['tahun_terbit'];?>" class="form-control rounded-0">
					</div>
					<div class="col-md-2">
						<label class="text-black" for="lname">Stok</label>
						<input type="text" name="stok" value="<?php echo $r['stok']; ?>" class="form-control rounded-0">
					</div>
				</div>
				<br>
				<div class="row form-group">
