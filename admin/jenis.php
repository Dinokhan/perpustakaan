	...
	<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
		...
		<div class="site-wrap"  id="home-section">
			...
			<div class="alert alert-primary" role="alert">
				<br><br><br><br>
				<h1 class="display-4">Master Jenis Buku</h1>
			...
			<div class="container-fluid">
				<a href="form_jenis.php"><button type="button" class="btn btn-primary btn-lg">Tambah Data</button></a>
				<button type="button" class="btn btn-danger btn-lg">Hapus Semua Data</button>
				<form action="jenis.php" method="POST" class="form-inline my-2 my-lg-0">
					<ul class="navbar-nav mr-auto">
					</ul>
					<input class="form-control mr-sm-2" type="search" placeholder="Cari Jenis Buku" aria-label="Search" name="cari">
			...
			<table class="table">
				...
				<tbody>
					...
					if (isset($_POST['cari'])){
						$cari=$_POST['cari'];
						$buku  = mysqli_query($koneksi, "SELECT * FROM jenis_buku where nama_jenisbuku like '%$cari%'") or die(mysqli_error());  

					}
					else {
						$buku  = mysqli_query($koneksi, "SELECT * FROM jenis_buku") or die(mysqli_error());
					}
				...
				// $tampil=mysqli_query($koneksi, "SELECT * FROM buku");
					...
					while ($r=mysqli_fetch_array($buku)){
						...
						<tr>
							<!-- <th scope="row">1</th> -->
							<th><?php echo "$no"; ?></th>
							<td><?php echo "$r[kode_jenisbuku]"; ?></td>
							<td><?php echo "$r[nama_jenisbuku]"; ?></td>
							<td>
								<!-- buat view data -->
<!-- 								<a <?php  //echo "href='view_buku.php?id=$r[kode_jenisbuku]'" ;?>>
									<button type="button" class="btn btn-primary btn-lg">
										<img width="20%" height="10%" src="icon/view.png"/>
									</button>
								</a>
 -->								<!-- buat view data -->
								...
								<!-- buat update data -->
								<a <?php  echo "href='update_jenisbuku.php?id=$r[kode_jenisbuku]'" ;?>>
									<button type="button" class="btn btn-success btn-lg">
										<img width="20%" height="10%" src="icon/upload.png"/>
									</button>
								</a>
								<!-- buat update data -->

								<!-- buat memnghapus data -->
								<a onclick="return confirm('Apakah anda yakin ingin menghapus !!!')"<?php  echo "href='jenisbuku_hapus.php?id=$r[kode_jenisbuku]'" ;?>>
									<button type="button" class="btn btn-danger btn-lg">
										<img width="20%" height="10%" src="icon/delete.png"/>
									</button>
								</a>
								<!-- buat memnghapus data -->
