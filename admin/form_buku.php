...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			<h1 class="display-4" align="center">Silahkan Input Data</h1>
		...
		<div class="container alert alert-dark">
			<form action="aksi_form_buku.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Input Buku</h2> 

				<div class="row form-group">
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">Kode Buku</label>
						<input type="text" name="kd_buku" class="form-control rounded-0">
					</div>
					<div class="col-md-8">
						<label class="text-black" for="lname">Judul Buku</label>
						<input type="text" name="judul_buku" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-12">
						<label class="text-black" for="email">Pengarang</label> 
						<input type="text" name="pengarang" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-4	">
						<label class="text-black" for="lname">Kode J.Buku</label> 
						<select name="kode_jenisbuku" class="form-control">
    <option value="" selected="selected">-</option>
    <?php 
     $tampil=mysqli_query($koneksi,"SELECT * FROM jenis_buku ORDER BY kode_jenisbuku");
     while($r=mysqli_fetch_array($tampil)){
      echo "<option value=$r[kode_jenisbuku]>$r[nama_jenisbuku]</option>";
     }
     ?>
 </select>
					</div>
				...
				<div class="row form-group">
					<div class="col-md-8 mb-3 mb-md-0">
						...
						<input type="text" name="penerbit" class="form-control rounded-0">
					</div>
					<div class="col-md-2">
						<label class="text-black" for="lname">Tahun Terbit</label>
						<input type="text" name="tahun_terbit" class="form-control rounded-0">
					</div>
					<div class="col-md-2">
						<label class="text-black" for="lname">Stok</label>
						<input type="text" name="stok" class="form-control rounded-0">
					</div>
				</div>
				<br>
				<div class="row form-group">
