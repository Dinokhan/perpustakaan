	...
	<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
		...
		<div class="site-wrap"  id="home-section">
			...
			<div class="alert alert-primary" role="alert">
				<br><br><br><br>
				<h1 class="display-4">Master Buku</h1>
			...
			<div class="container-fluid">
				<a href="form_buku.php"><button type="button" class="btn btn-primary btn-lg">Tambah Data</button></a>
				<button type="button" class="btn btn-danger btn-lg">Hapus Semua Data</button>
				<form action="buku.php" method="POST" class="form-inline my-2 my-lg-0">
					<ul class="navbar-nav mr-auto">
					</ul>
					<input class="form-control mr-sm-2" type="search" placeholder="Cari Nama buku" aria-label="Search" name="cari">
			...
			<table class="table">
				<thead class="thead-dark">
					<tr>
						...
						<th scope="col">Kode Jenis Buku</th>
				...
				<tbody>
					...
					if (isset($_POST['cari'])){
						$cari=$_POST['cari'];
						$buku  = mysqli_query($koneksi, "SELECT * FROM buku where judul_buku like '%$cari%'") or die(mysqli_error());  

					}
					else {
						$buku  = mysqli_query($koneksi, "SELECT * FROM buku ") or die(mysqli_error());
					}
				...
				// $tampil=mysqli_query($koneksi, "SELECT * FROM buku");
					...
					while ($r=mysqli_fetch_array($buku)){
						...
						<tr>
							...
							<td>
								<!-- buat view data -->
								<!-- <a <?php  //echo "href='view_buku.php?id=$r[kd_buku]'" ;?>>
								...
								<!-- buat update data -->
								<a <?php  echo "href='update_buku.php?id=$r[kd_buku]'" ;?>>
								...
								<a onclick="return confirm('Apakah anda yakin ingin menghapus !!!')" <?php  echo "href='buku_hapus.php?id=$r[kd_buku]'" ;?>>
