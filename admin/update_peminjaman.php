...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			<form action="aksi_update_pinjam.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Ubah Data</h2> 

				<div class="row form-group">
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">ID Pinjam</label>
						<input type="text" name="id_peminjaman" readonly value="<?php echo $r['id_peminjaman'];?>" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					<div class="col-md-6 mb-3 mb-md-0">
						...
						<input type="date" name="tgl_peminjaman" value="<?php echo $r['tgl_peminjaman'];?>" class="form-control rounded-0">
					</div>
					<div class="col-md-6">
						<label class="text-black" for="lname">TGL Kembali</label>
						<input type="date" name="tgl_kembali" value="<?php echo $r['tgl_kembali'];?>" class="form-control rounded-0">
					</div>
				</div>
