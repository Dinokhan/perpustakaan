	...
	<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
		...
		<div class="site-wrap"  id="home-section">
			...
			<div class="alert alert-primary" role="alert">
				<br><br><br><br>
				<h1 class="display-4">Master Transaksi</h1>
			...
			<div class="container-fluid">
				<a href="form_transaksi.php"><button type="button" class="btn btn-primary btn-lg">Tambah Data</button></a>
				<button type="button" class="btn btn-danger btn-lg">Hapus Semua Data</button>
				<form action="transaksi_peminjaman.php" method="POST" class="form-inline my-2 my-lg-0">
					<ul class="navbar-nav mr-auto">
					</ul>
					<input class="form-control mr-sm-2" type="search" placeholder="Cari ID Transaksi" aria-label="Search" name="cari">
			...
			<table class="table">
				...
				<tbody>
					...
					if (isset($_POST['cari'])){
						$cari=$_POST['cari'];
						$buku  = mysqli_query($koneksi, "SELECT * FROM transaksi_peminjaman where id_transaksipeminjaman like '%$cari%'") or die(mysqli_error());  

					}
					else {
						$buku  = mysqli_query($koneksi, "SELECT * FROM transaksi_peminjaman") or die(mysqli_error());
					}
				...
				// $tampil=mysqli_query($koneksi, "SELECT * FROM buku");
					...
					while ($r=mysqli_fetch_array($buku)){
						...
						$tampil2=mysqli_query($koneksi,"SELECT * FROM peminjaman WHERE id_peminjaman='$r[id_peminjaman]' ");
						...
						<tr>
							...
							<th><?php echo "$no"; ?></th>
							<td><?php echo "$r[id_transaksipeminjaman]"; ?></td>
							<td><?php echo "$r[id_peminjaman]"; ?></td>
							<td><?php echo "$r2[id_member]"; ?></td>
							<td><?php echo "$r2[kd_buku]"; ?></td>
							<td><?php echo "$r2[tgl_peminjaman]"; ?></td>
							<td><?php echo "$r2[tgl_kembali]"; ?></td>
							<td><?php echo "$r[tardiness]"; ?></td>
							<td><?php echo "$r[denda]"; ?></td>
							<td><?php echo "$r[qty]"; ?></td>

							<td>
								<!-- buat view data -->
<!-- 								<a <?php  //echo "href='view_buku.php?id=$r[id_transaksipeminjaman]'" ;?>>
		 ...
		 -->						<!-- buat view data -->
								...
								<!-- buat update data -->
								<a <?php  echo "href='update_transaksi.php?id=$r[id_transaksipeminjaman]'" ;?>>
								...
								<a onclick="return confirm('Apakah anda yakin ingin menghapus !!!')" <?php  echo "href='transaksi_hapus.php?id=$r[id_transaksipeminjaman]&qty=$r[qty]&kd_buku=$r[kd_buku]'" ;?>>
