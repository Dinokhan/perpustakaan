    ...
    <div class="container d-none d-lg-block">
      <div class="row">
        <div class="col-12 text-center mb-4 mt-5">
          <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Perpustakaan<span class="text-primary">.</span> </a></h1>
        </div>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-6 col-md-6 col-xl-2  d-block d-lg-none">
            ...
            <h1 class="mb-0 site-logo">
              <a href="index.html" class="text-black h2 mb-0"><?php $_SESSION['username'];?>
        ...
        <div class="col-12 col-md-10 main-menu">
          <nav class="site-navigation position-relative text-right" role="navigation">
            ...
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              ...
              <li><a href="#features-section" class="nav-link">Buku</a></li>
              <li><a href="#about-section" class="nav-link">Jenis Buku</a></li>
              <li><a href="#testimonials-section" class="nav-link">Member</a></li>
              <li><a href="#blog-section" class="nav-link">Peminjaman</a></li>
              <li><a href="#contact-section" class="nav-link">Transaksi</a></li>
              <li><a href="#contact-section" class="nav-link">Tentang</a></li>
            </ul>
          </nav>
        </div>
        ...
        <div class="col-md-12" style="position: relative;" data-aos="fade-up">
          ...
          <div class="row mb-4">
            <div class="col-lg-4 mr-auto">
              ...
              <p class="mb-5">Dengan sebuah buku kita dapat mendapatkan semua nya </p>
              <div>
                <a href="login.php" class="btn btn-primary mr-2 mb-2">Masuk</a>
                <a href="register.php" class="btn btn-primary mr-2 mb-2">Daftar</a>
              </div>
            </div>
