...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<div class="site-wrap"  id="home-section">
		...
		<div class="container alert alert-dark">
			<form action="aksi_form_member.php" class="p-5 bg-white" method="POST">

				<h2 class="h4 text-black mb-5">Masukan Member</h2> 

				<div class="row form-group">
					<div class="col-md-4 mb-3 mb-md-0">
						<label class="text-black" for="fname">ID Member</label>
						<input type="text" name="id_member" class="form-control rounded-0">
					</div>
					<div class="col-md-8">
						<label class="text-black" for="lname">Nama Member</label>
						<input type="text" name="nama_member" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-12">
						...
						<input type="text" name="alamat" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-8">
						...
						<input type="subject" name="telepon" class="form-control rounded-0">
					</div>
				</div>
				...
				<div class="row form-group">
					<div class="col-md-8 mb-3 mb-md-0">
						...
						<input type="date" name="tgl_lahir" class="form-control rounded-0">
					</div>
